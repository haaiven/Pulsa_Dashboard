...
INITIAL_EXPECTED_FILES = [
    ...
    ("PTR-BAS-DANA", "EXTERNAL_PARTNER_FILE", "DANA", "MERCHANT_SETTLEMENT_216620001425561916643_{YYYYMMDD}.csv", True, True),
    ("PTR-BAS-DANA", "INTERNAL_RECON_FILE", "BAS", "recon_bas_dana_{YYYYMMDD}.xlsx", True, True),
    ("PTR-BMD-DANA", "INTERNAL_RECON_FILE", "BMD", "bmd_dana_DDMMYYYY.xlsx", True, True),
    ("PTR-BMD-DANA", "EXTERNAL_PARTNER_FILE", "DANA", "MERCHANT_SETTLEMENT_216620001012430848275_{YYYYMMDD}.csv", True, True),
    ("PTR-BMD-DANA", "INTERNAL_RECON_FILE", "BMD", "recon_bmd_dana_{YYYYMMDD}.xlsx", True, True),
