...
export default function WeeklyPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["dashboard-weekly", startDate, endDate],
    queryFn: async () => (await api.get("/dashboard/weekly", { params: { start_date: startDate, end_date: endDate } })).data,
  });

  return (
    <div>
      <h2 className="text-2xl font-bold mb-6">Dashboard Mingguan</h2>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="text-right">Total</TableHead><TableHead className="text-right">Success</TableHead><TableHead className="text-right">Pending</TableHead><TableHead className="text-right">Failed</TableHead>
